...
git clone https://github.com/YOUR_USERNAME/claude-code-academic-workflow.git my-project
cd my-project
```
...
<details>
<summary><strong>10 agents, 24 skills, 18 rules, 7 hooks</strong> (click to expand)</summary>
...
| `/review-paper` | Manuscript review: structure, methodology, referee objections |
| `/data-analysis` | End-to-end analysis with publication-ready output |
